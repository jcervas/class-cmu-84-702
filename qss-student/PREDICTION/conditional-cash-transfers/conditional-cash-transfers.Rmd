...
*conditional cash transfer program* (CCT program). This
  exercise is based on the following article: 
  
  Ana de la O. (2013). 'Do Conditional Cash Transfers Affect Voting Behavior? Evidence
  from a Randomized Experiment in Mexico.'  *American Journal of
    Political Science*, 57:1, pp.1-14. and Kosuke Imai,
  Gary King, and Carlos Velasco. (2020). 'Do Nonpartisan Programmatic
  Policies Have Partisan Electoral Effects? Evidence from Two Large
  Scale Randomized Experiments.' *Journal of Politics*, 82:2, pp. 714-730.
