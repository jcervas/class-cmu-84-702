...
## Question 8
Repeat the analysis in the Question 5, but fit the linear regression by year.
Which year has a positive coefficient of candidate co-ethnicity?
Use `for loop` to check each year. In the loop, use `if()` to check the
coefficient and print out the year if the coefficient of candidate co-ethnicity (`candidate`)
is positive.
